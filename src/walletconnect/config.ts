...
export const walletConnectConfig = {
  ...
  metadata: {
    ...
    url: 'https://state-keeper-protocol.com', // Update with your actual URL
    icons: ['https://state-keeper-protocol.com/icon.png'], // Update with your actual icon
  },
  // Deployed contract address
  contractAddress: 'SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.state-keeper-protocol',
