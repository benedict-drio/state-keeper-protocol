 ...
 * Deployed at: SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.state-keeper-protocol
 */
...
export const SENTINEL_CONTRACT = {
  address: 'SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.state-keeper-protocol',
  mainnet: 'SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.state-keeper-protocol',
...
/**
 * Example: Call a read-only function on the state-keeper-protocol contract
 */
...
/**
 * Example: Call a public function on the state-keeper-protocol contract
