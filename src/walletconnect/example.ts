 ...
 * to enable wallet connections and interact with the state-keeper-protocol contract.
 */
...
export async function exampleContractInteraction() {
  ...
  const exampleRequest = {
    ...
    params: {
      contract: 'SP3P2G9ZK7B309EGAM9QAM143YGDNBGGQAXDAS1GW.state-keeper-protocol',
